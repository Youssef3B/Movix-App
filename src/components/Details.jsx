...
function Details() {
  ...
  useEffect(
    function () {
      async function getSimilar() {
        const res = await fetch(
          `https://api.themoviedb.org/3/movie/${id}/similar?language=en-US&page=1&api_key=${KEY}`
        );
        const data = await res.json();
  ...
  useEffect(
    function () {
      async function getRecommendations() {
        const res = await fetch(
          `https://api.themoviedb.org/3/movie/${id}/recommendations?language=en-US&page=1&api_key=${KEY}`
        );
        const data = await res.json();
        if (Array.isArray(data.results)) {
  ...
  const inputDateStr = detailMovie.release_date;
          ...
          {detailMovie && (
            <>
              ...
              <ul>
                ...
                <li>
                  Runtime: <span>{detailMovie.runtime}m</span>
                </li>
              </ul>
              <ul>
                <li>
