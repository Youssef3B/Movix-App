...
function Query({ movie }) {
  ...
  const vote_average =
    typeof vote === "number" ? vote.toFixed(1).slice(0, 3) : "N/A";
  // Input date string in the "YYYY-MM-DD" format
  const inputDateStr = movie.release_date || movie.first_air_date;
  ...
  return (
    <div className={styles.card}>
      ...
      <h3>{movie.title || movie.name || "No Title Available"}</h3>
